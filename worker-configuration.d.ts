/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 4377f1c6e4f5ae70c55f727cb9f16862)
...
interface __BaseEnv_CloudflareBindings {
	...
	MAX_RELEASES_PER_APP: string;
	MAX_PATCHES_PER_RELEASE: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "S3_ACCESS_KEY_ID" | "S3_ACCESS_KEY" | "S3_BUCKET" | "S3_ENDPOINT" | "S3_REGION" | "S3_PRESIGNED_EXPIRE_SECONDS" | "MAX_RELEASES_PER_APP" | "MAX_PATCHES_PER_RELEASE">> {}
}
